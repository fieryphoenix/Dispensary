                ...
                <div id="collapseSearch" class="panel-collapse collapse">
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <@spring.formInput "SearchCriteria.patient" "class='form-control' placeholder='${springMacroRequestContext.getMessage('page.field.patient.fullName')}'" "text"/><@spring.showErrors "<br>"/>
                            </div>
                        </div>
                    </div>
                </div>
